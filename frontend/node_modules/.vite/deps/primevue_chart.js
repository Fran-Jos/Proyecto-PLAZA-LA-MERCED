import { Dt as mergeProps, Vt as openBlock, W as createBaseVNode, q as createElementBlock } from "./vue.runtime.esm-bundler-CMLZRQMs.js";
import { t as BaseStyle } from "./style-C-9SDo2a.js";
import { t as script$1 } from "./basecomponent-CVrrbAzA.js";
//#region node_modules/primevue/chart/style/index.mjs
...
//#endregion
//#region node_modules/primevue/chart/index.mjs
var script = {
	name: "Chart",
	"extends": {
		name: "BaseChart",
	...
	methods: {
		initChart: function initChart() {
			var _this = this;
			import("./auto-BkctFiWd.js").then(function(module) {
				if (_this.chart) {
					_this.chart.destroy();
					_this.chart = null;
				}
				if (module && module["default"]) _this.chart = new module["default"](_this.$refs.canvas, {
					type: _this.type,
					data: _this.data,
		...
		onCanvasClick: function onCanvasClick(event) {
			if (this.chart) {
				...
				if (element && element[0] && dataset) this.$emit("select", {
					originalEvent: event,
					element: element[0],
					dataset
				});
